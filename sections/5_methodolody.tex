...
\begin{enumerate}
    ...
    \item \textbf{Architecture Tools Used}:
        \begin{enumerate}
            ...
            \item \textbf{Hardware Sensors (Refer to Section \ref{sec:ArduinoSensors})}: Utilized various sensors as detailed in Section \ref{sec:ArduinoSensors} for hardware integration within the system, enabling data collection and interaction with physical components.
        \end{enumerate}
    \end{itemize}
...
\item \textbf{Building Prototype}:
    ...
    \begin{enumerate}
        \item Used the Anycubic Kobra 3D \cite{anycubic-kobra} printer to manufacture prototypes, enabling the installation of various sensors and components to support design validation and iterative development.
    \end{enumerate}
    \end{itemize}
\end{enumerate}
